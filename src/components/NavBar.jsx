...
const NavBar = () => {
  ...
  return (
    <div className="w-full xl:h-24 lg:h-20 h-16 flex flex-row items-center justify-between lg:px-32 sm:px-20 px-10 shadow-lg fixed bg-white z-30 secondary-font">
      {/* logo */}
      <a
